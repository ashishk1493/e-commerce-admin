...
import { add_product_service } from 'services/ecom_product.service';
...
export default function addProduct(props) {
  ...
  return (
    <FormCover
      ...
      breadcomeTitle={'Add Product'}
      breadcomeLinks={[{ name: 'Home', href: PATH_DASHBOARD.root }, { name: 'Add Product' }]}
    >
      <FormikCommanNew
        loading={loading}
        schema={{
        ...
        onSubmitProps={async (values) => {
          ...
          setLoading(true);
          let res = await anqAddform(values, add_product_service, redirectOnSuc);
          setLoading(false);
        }}
        Ch={EcomProductAdd}
      />
